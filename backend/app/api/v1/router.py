...
from app.api.v1.endpoints import faculty_router, subject_router, section_router, room_router, timetable_router, report_router, export_router
...
api_router.include_router(export_router.router, prefix="/export", tags=["export"])
